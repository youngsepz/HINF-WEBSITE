...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div
            ...
            ref={containerRef}
        >
            <div className="max-w-7xl mx-auto pt-20 px-4 md:px-6 lg:px-4 border-left-2">
                ...
                <p className="text-neutral-700 dark:text-neutral-300 font-semibold text-sm md:text-lg max-w-full">
                    University of Victoria's School of Health Information
                    Science is the most established health informatics school in
                    Canada.
                </p>
            </div>
                    ...
                    >
                        <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                            <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
                                <div className="h-4 w-4 rounded-full bg-neutral-200 dark:bg-neutral-200 border border-neutral-300 dark:border-neutral-700 p-2" />
                            </div>
                            <h3 className="hidden md:block text-xl md:pl-20 md:text-5xl font-bold text-blue-400 dark:text-slate-200 ">
                                {item.title}
                            </h3>
                        </div>
