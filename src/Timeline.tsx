  ...
  const data = [
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-8 animate-appear bg-gradient-to-r from-sky-900 to-blue-900 bg-clip-text text-2xl font-semibold leading-tight text-transparent drop-shadow-2xl sm:text-2xl sm:leading-tight md:text-4xl md:leading-tight ">
            Combined Computer Science and Health Information Science Major Introduced
          </p>
          <div className="mb-8">
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Card grid component
      ...
      content: (
        <div>
          <p className="mb-8 animate-appear bg-gradient-to-r from-sky-900 to-blue-900 bg-clip-text text-2xl font-semibold leading-tight text-transparent drop-shadow-2xl sm:text-2xl sm:leading-tight md:text-4xl md:leading-tight ">
            Master of Nursing and Master of Science in Health Informatics double degree program introduced
          </p>
          <div className="mb-8">
            <div className="flex gap-2 items-center text-neutral-700 dark:text-neutral-300 text-xs md:text-sm">
              ✅ Card grid component
