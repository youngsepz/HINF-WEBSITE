export default function EmploymentRate() {
    return (
        ...
        <div className="m-auto max-w-xl text-6xl p-0">
            <img src="./src/assets/timeline-pictures/jasonandstudent.png" alt="" className="" />
        </div>
        <div className="max-w-xl flex flex-col gap-3 text-[2rem] light:text-[#121212] dark:text-slate-100 p-8">
            <div className="pl-0 h-14 w-24 text-blue-200"><img src="./src/assets/timeline-pictures/handshake.svg" alt="" className="fill-current text-green-600" /></div>
            ...
            <div className="text-lg p-1 px-2 size-fit text-black bg-blue-800 text-white font-semibold rounded-lg">Common Positions</div>
            <div className="grid grid-cols-1 grid-rows-3 text-2xl pl-1 gap-3 text-slate-600 dark:text-slate-300 tracking-tight ">
